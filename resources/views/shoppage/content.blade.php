...
<div class="col-md-12 col-lg-12 order-2" style="background: white">
            ...
            <div class="row mb-5 filtersearch">
              @foreach($data as $d)
              <div class="col-sm-12 col-xs-12 col-md-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class=" border-unit">
                  ...
                  <div class="content-unit">
                    ...
                    <div class="block-unit">
                      <p class="mb-0"> Năm sinh: <span class="number-unit">{{$d->brithday}}</span></p>
